...
<div class="leading-loose flex justify-center">
    <form name="inscription" class="w-75  p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('newPassword') }}" oninput='password2.setCustomValidity(password2.value != password.value ? "Les mots de passe ne correspondent pas." : "")'>
        <div class="md-form">
